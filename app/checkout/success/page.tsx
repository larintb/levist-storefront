...
function SuccessContent() {
  ...
  return (
    <div className="max-w-lg mx-auto px-6 py-28 flex flex-col items-center text-center gap-8">
      {/* Icono */}
      <div className="w-20 h-20 bg-[#8AA7C4] flex items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full">
        <Link
          href="/catalogo"
          className="flex-1 py-4 bg-[#364458] text-white text-center text-xs font-black uppercase tracking-widest hover:bg-[#2F3F55] transition-colors"
        >
          Seguir Comprando
        </Link>
        <Link
          href="/"
          className="flex-1 py-4 border border-gray-300 text-center text-xs font-black uppercase tracking-widest hover:border-[#364458] transition-colors"
        >
          Ir al Inicio
        </Link>
      </div>
